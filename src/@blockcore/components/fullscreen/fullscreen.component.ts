...
import { FSDocument, FSDocumentElement } from '@blockcore/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'blockcore-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'blockcoreFullscreen'
})
export class blockcoreFullscreenComponent implements OnInit
{
