...
@Component({
    selector       : 'blockcore-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : blockcoreAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class blockcoreVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    {
        return {
            'blockcore-vertical-navigation-item-collapsed': this.isCollapsed,
            'blockcore-vertical-navigation-item-expanded' : this.isExpanded
        };
    }
    ...
    ngOnInit(): void
    {
        ...
        this._blockcoreVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._blockcoreVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._blockcoreVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._blockcoreVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _hasActiveChild(item: blockcoreNavigationItem, currentUrl: string): boolean
    {
     ...
     * @private
     */
    private _isChildrenOf(parent: blockcoreNavigationItem, item: blockcoreNavigationItem): boolean
    {
