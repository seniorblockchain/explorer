...
import { blockcoreMockApiReplyCallback } from '@blockcore/lib/mock-api/mock-api.types';

export class blockcoreMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: blockcoreMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: blockcoreMockApiReplyCallback): void
    {
        // Store the reply
