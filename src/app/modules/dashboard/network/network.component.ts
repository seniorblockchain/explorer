...
import { NetworkService } from 'app/modules/dashboard/network/network.service';
...
export class NetworkComponent implements OnInit, OnDestroy
{
    ...
    async updateNetwork() {
        ...
        try {
          this.error = null;
          const url = this.setup.Explorer?.Network?.ApiUrl;
          ...
          const changePercentage = this.navigator(request, this.setup.Explorer.Network.PercentagePath);
          ...
          this.network = {
            btc: this.navigator(request, this.setup.Explorer.Network.PricePathBTC),
            usd: this.navigator(request, this.setup.Explorer.Network.PricePathUSD),
            changePercentage,
            changeType
          };
        }
        catch (err) {
          this.network = { btc: null, usd: null, changePercentage: null, changeType: null };
          this.error = err;
        }
      }
