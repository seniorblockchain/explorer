...
export class InsightComponent implements OnInit, OnDestroy
{
    ...
    async updateInsight() {
        ...
        try {
          this.error = null;
          const url = this.setup.Explorer?.Insight?.ApiUrl;
          ...
          const changePercentage = this.navigator(request, this.setup.Explorer.Insight.PercentagePath);
          ...
          this.insight = {
            btc: this.navigator(request, this.setup.Explorer.Insight.PricePathBTC),
            usd: this.navigator(request, this.setup.Explorer.Insight.PricePathUSD),
            changePercentage,
            changeType
          };
        }
        catch (err) {
          this.insight = { btc: null, usd: null, changePercentage: null, changeType: null };
          this.error = err;
        }
      }
