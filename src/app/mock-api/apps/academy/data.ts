...
export const courses = [
    ...
    },
    {
        ...
        title      : 'Personalize Your iOS App with Firebase Coin Management',
        slug       : 'personalize-your-ios-app-with-firebase-coin-management',
        description: 'Dive deep into Coin Management on iOS apps using Firebase',
        category   : 'firebase',
        duration   : 90,
        totalSteps : 11,
...
export const demoCourseSteps = [
    ...
    {
        order   : 7,
        title   : 'Welcome New Coins',
        subtitle: 'How to create a welcome message for the new coins',
        content : `<h2 class="text-2xl sm:text-3xl">Welcome New Coins</h1> ${demoCourseContent}`
    },
    {
        order   : 8,
    ...
    },
    {
        ...
        subtitle: 'How to create and push a notification to a coin',
