...
import { blockcoreMockApiService, blockcoreMockApiUtils } from '@blockcore/lib/mock-api';
    ...
    registerHandlers(): void
    {
        ...
        this._blockcoreMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newTag.id = blockcoreMockApiUtils.guid();
        ...
        this._blockcoreMockApiService
            ...
            .reply(({request}) => {
                ...
                // and encoded images.
                return from(readAsDataURL(logo)).pipe(
                    map((path) => {
