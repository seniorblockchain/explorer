...
/**
 *  If a message belongs to our coin, it's marked by setting it as
 *  'me'. If it belongs to the coin we are chatting with, then it
...
export const contacts = [
    {
        ...
        about      : 'Hi there! I\'m using blockcoreChat.',
        details    : {
            emails      : [
                {
