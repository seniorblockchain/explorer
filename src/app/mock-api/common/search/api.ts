...
import { blockcoreNavigationItem, blockcoreNavigationService } from '@blockcore/components/navigation';
...
export class SearchMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._blockcoreNavigationService.getFlatNavigation(this._defaultNavigation);
