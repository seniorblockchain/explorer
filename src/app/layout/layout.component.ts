...
import { blockcore_VERSION } from '@blockcore/version';
...
export class LayoutComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        combineLatest([
            ...
            this._blockcoreMediaWatcherService.onMediaQueryChange$(['(prefers-color-scheme: dark)', '(prefers-color-scheme: light)'])
        ]).pipe(
        ...
        // Set the app version
        this._renderer2.setAttribute(this._document.querySelector('[ng-version]'), 'blockcore-version', blockcore_VERSION);
    }
